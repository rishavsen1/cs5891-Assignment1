...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        for a in legal_actions:
          q_vals[a] = self.getQValue(state, a)

        #return best q value from all q_val for action a
    ...
    def update(self, state, action, nextState, reward):
        ...
        old_q_vals = self.getQValue(state, action)
        reward = self.alpha * reward

        self.q_vals[(state, action)] = (1-self.alpha) * old_q_vals + reward
